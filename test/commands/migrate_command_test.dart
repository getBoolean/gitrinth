...
''');
  ...
  test(
    're-migrate recovers a previously-marked entry to a fresh caret',
    () async {
...
''');
  ...
  test('migrate disables both endpoints of a mutual-incompatibility conflict, '
      'writes a lock for the shrunk pack, exits 0 with a warning', () async {
...
''');
  ...
  test('re-running migrate with a still-conflicting graph keeps the '
      'disabled-by-conflict markers in place', () async {
    modrinth
      ..registerVersion(
        slug: 'a',
        versionNumber: '1.0.0',
...
''');
  ...
  test('re-running migrate recovers a disabled-by-conflict entry once the '
      'conflict is gone', () async {
    modrinth
      ..registerVersion(
        slug: 'a',
        versionNumber: '1.0.0',
...
''');
  ...
  test('get tolerates disabled-by-conflict marker entries: skips them, '
      'surfaces nag, enforce-lockfile passes', () async {
    modrinth
      ..registerVersion(
        slug: 'a',
        versionNumber: '1.0.0',
